...
class ViewPanel extends Container {
  constructor(events: Events, tooltips: Tooltips, args = {}) {
    ...
    tooltips.register(
      bgClrPicker,
      localize("panel.view-options.background-color"),
      "left",
    );
    tooltips.register(
      selectedClrPicker,
      localize("panel.view-options.selected-color"),
      "top",
    );
    tooltips.register(
      unselectedClrPicker,
      localize("panel.view-options.unselected-color"),
      "top",
    );
    tooltips.register(
      lockedClrPicker,
      localize("panel.view-options.locked-color"),
      "top",
    );
  }
}
