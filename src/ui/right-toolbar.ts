...
import cameraFrameSelectionSvg from "./svg/camera-frame-selection.svg?raw";
import cameraResetSvg from "./svg/camera-reset.svg?raw";
import centersSvg from "./svg/centers.svg?raw";
import colorPanelSvg from "./svg/color-panel.svg?raw";
import ringsSvg from "./svg/rings.svg?raw";
import showHideSplatsSvg from "./svg/show-hide-splats.svg?raw";
