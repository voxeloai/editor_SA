...
import brushSvg from "./svg/select-brush.svg?raw";
import eyedropperSvg from "./svg/select-eyedropper.svg?raw";
import floodSvg from "./svg/select-flood.svg?raw";
import lassoSvg from "./svg/select-lasso.svg?raw";
import pickerSvg from "./svg/select-picker.svg?raw";
import polygonSvg from "./svg/select-poly.svg?raw";
import sphereSvg from "./svg/select-sphere.svg?raw";
import boxSvg from "./svg/show-hide-splats.svg?raw";
