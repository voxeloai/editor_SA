...
class ImageSettingsDialog extends Container {
  ...
  constructor(events: Events, args = {}) {
    ...
    const headerText = new Label({
      id: "text",
      text: localize("popup.render-image.header").toUpperCase(),
    });
    ...
    const presetLabel = new Label({
      class: "label",
      text: localize("popup.render-image.preset"),
    });
    ...
    const resolutionLabel = new Label({
      class: "label",
      text: localize("popup.render-image.resolution"),
    });
    ...
    const transparentBgLabel = new Label({
      class: "label",
      text: localize("popup.render-image.transparent-bg"),
    });
    ...
    const showDebugLabel = new Label({
      class: "label",
      text: localize("popup.render-image.show-debug"),
    });
    ...
    const updateResolution = () => {
      ...
      resolutionValue.value = [
        widths[presetSelect.value],
        heights[presetSelect.value],
      ];
    };
