      ...
      resources: {
        de: {
          translation: {
            ...
            "shortcuts.toggle-gizmo-coordinate-space":
              "Gizmoanzeige umschalten",
            ...
            "doc.unsaved-message":
              "Sie haben ungespeicherte Änderungen. Möchten Sie die Szene wirklich zurücksetzen?",
            ...
            "publish.message":
              "Verwenden Sie den Link unten, um auf Ihre Szene zuzugreifen.",
            "publish.please-log-in":
              "Das Veröffentlichen in PlayCanvas erfordert ein Benutzerkonto. Bitte melden Sie sich an und versuchen Sie es erneut.",
        ...
        en: {
          translation: {
            ...
            "doc.unsaved-message":
              "You have unsaved changes. Are you sure you want to reset the scene?",
            ...
            "publish.please-log-in":
              "Publishing to PlayCanvas requires a user account. Please log in and try again.",
        ...
        fr: {
          translation: {
            ...
            "shortcuts.focus-camera":
              "Focaliser la caméra sur la sélection actuelle",
            "shortcuts.toggle-camera-mode": "Basculer le mode de camera",
            "shortcuts.toggle-grid": "Afficher/Cacher la grille",
            "shortcuts.toggle-gizmo-coordinate-space":
              "Basculer en espace de coordonnées Gizmo",
            ...
            "doc.unsaved-message":
              "Vous avez des modifications non enregistrées. Êtes-vous sûr de vouloir réinitialiser la scène?",
            "doc.reset-message":
              "Êtes-vous sûr de vouloir réinitialiser la scène?",
            ...
            "publish.message":
              "Utilisez le lien ci-dessous pour accéder à votre scène.",
            "publish.please-log-in":
              "La publication sur PlayCanvas nécessite un compte utilisateur. Veuillez vous connecter et réessayer.",
        ...
        ja: {
          translation: {
            ...
            "shortcuts.undo": "元に戻す",
            "shortcuts.redo": "やり直し",
            "shortcuts.toggle-splat-overlay":
              "スプラットオーバーレイの切り替え",
            ...
            "doc.reset": "シーンをリセット",
            "doc.unsaved-message":
              "保存されていない変更があります。シーンをリセットしてもよろしいですか？",
            ...
            "publish.message":
              "以下のリンクを使用してシーンにアクセスしてください。",
            "publish.please-log-in":
              "PlayCanvasに公開するにはユーザーアカウントが必要です。ログインしてもう一度お試しください。",
        ...
        ko: {
          translation: {
            ...
            "doc.reset": "장면 재설정",
            "doc.unsaved-message":
              "저장되지 않은 변경 사항이 있습니다. 장면을 재설정하시겠습니까?",
            ...
            "publish.please-log-in":
              "PlayCanvas에 게시하려면 사용자 계정이 필요합니다. 로그인하고 다시 시도하십시오.",
        ...
        "zh-CN": {
          translation: {
            ...
            "publish.please-log-in":
              "要在 PlayCanvas 上发布，需要用户帐户。请登录并重试。",
