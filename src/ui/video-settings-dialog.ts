...
class VideoSettingsDialog extends Container {
  ...
  constructor(events: Events, args = {}) {
    ...
    const headerText = new Label({
      id: "text",
      text: localize("popup.render-video.header").toUpperCase(),
    });
    ...
    const resolutionLabel = new Label({
      class: "label",
      text: localize("popup.render-video.resolution"),
    });
    ...
    const formatLabel = new Label({
      class: "label",
      text: localize("popup.render-video.format"),
    });
    ...
    const codecLabel = new Label({
      class: "label",
      text: localize("popup.render-video.codec"),
    });
    ...
    const frameRateLabel = new Label({
      class: "label",
      text: localize("popup.render-video.frame-rate"),
    });
    ...
    const bitrateLabel = new Label({
      class: "label",
      text: localize("popup.render-video.bitrate"),
    });
    ...
    const frameRangeLabel = new Label({
      class: "label",
      text: localize("popup.render-video.frame-range"),
    });
    const frameRangeInput = new VectorInput({
      ...
      max: totalFrames - 1,
      placeholder: [
        localize("popup.render-video.frame-range-first"),
        localize("popup.render-video.frame-range-last"),
      ],
      precision: 0,
    ...
    const portraitLabel = new Label({
      class: "label",
      text: localize("popup.render-video.portrait"),
    });
    const portraitBoolean = new BooleanInput({
      class: "boolean",
      value: false,
    });
    ...
    const transparentBgLabel = new Label({
      class: "label",
      text: localize("popup.render-video.transparent-bg"),
    });
    const transparentBgBoolean = new BooleanInput({
      class: "boolean",
      value: false,
    });
    ...
    const showDebugLabel = new Label({
      class: "label",
      text: localize("popup.render-video.show-debug"),
    });
    const showDebugBoolean = new BooleanInput({
      class: "boolean",
      value: false,
    });
    ...
    this.show = () => {
      ...
      return new Promise<VideoSettings | null>((resolve) => {
        ...
        onOK = () => {
          ...
          const bppf =
            bppfs[bitrateSelect.value] * bbpfFactors[resolutionSelect.value];
