...
const main = async () => {
  console.log("[Main] Starting editor initialization...");
  // root events object
  ...
  // Register Iframe API FIRST to ensure it loads before any potential errors in other modules
  console.log("[Main] Registering Iframe API...");
  registerIframeApi(events);

  // Register events that do NOT depend on the scene (Critical: Timeline must be registered before EditorUI)
  ...
  // Register events that DEPEND on the scene
