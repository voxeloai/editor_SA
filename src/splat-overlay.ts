...
class SplatOverlay extends Element {
  ...
  add() {
    ...
    const update = (splat: Splat) => {
      ...
      material.setParameter(
        "splatPosition",
        (splat.entity.gsplat.instance.resource as GSplatResource)
          .transformATexture,
      );
      material.setParameter("splatTransform", splat.transformTexture);
      material.setParameter("texParams", [
        splat.stateTexture.width,
        splat.stateTexture.height,
      ]);
      material.update();
  ...
  onPreRender() {
    ...
    if (
      ...
      material.setParameter(
        "transformPalette",
        this.splat.transformPalette.texture,
      );
